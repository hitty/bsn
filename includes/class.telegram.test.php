<?php
  ...
  class TelegramException extends Exception{
      ...
      public static function exceptionHandler(TelegramException $exception,$line_number){
          ...
          file_put_contents("modules/testtelegrambot/errors.log",$exception_info['message']." в строке ".$line_number." ".$exception_info['additional_description']."\r\n",FILE_APPEND);
          return true;
      }
  }
  class TelegramController{
      ...
      //test
      //set webhook https://api.telegram.org/bot312438821:AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/setWebhook?url=https://test.bsn.ru/testtelegramBot/AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/
      protected static $bot_token;
      protected static $webhook_url;
      protected static $api_url;
      
      //production
      //set webhook https://api.telegram.org/bot311655806:AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/setWebhook?url=https://www.bsn.ru/testtelegramBot/AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/
      ...
      */
      protected static function apiRequestGet($method, $parameters) {
          ...
          file_put_contents("modules/testtelegramBot/errors.log",date("d.m.Y H:i:s")." request: ".$url."\r\n\r\n",FILE_APPEND);
          //образец:
      ...
      */
      ...
      public static function checkWebHook(){
          ...
          //to set webhook: https://api.telegram.org/bot312438821:AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/setWebhook?url=https://test.bsn.ru/testtelegramBot/AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/
      ...
      public static function checkInputRequest(){
          ...
          $token_part = preg_replace("/\/$/si","",$token_part);
          if(!($_SERVER['REQUEST_METHOD'] == 'POST' && $_SERVER['REQUEST_URI'] == "/testtelegrambot/".$token_part."/")){
              throw new TelegramException("Неверный входящий запрос",1,"method = ".$_SERVER['REQUEST_METHOD']."\r\nuri = ".$_SERVER['REQUEST_URI']."\r\nexpected_token_part = ".$token_part."");
          }else file_put_contents("modules/testtelegrambot/errors.log",date("d.m.Y H:i:s")." REQUEST: ".$_SERVER['REQUEST_URI']."\r\n",FILE_APPEND);
          return true;
      }
      ...
      */
      public static function acceptRequest(){
          ...
          file_put_contents("modules/testtelegrambot/errors.log",date("d.m.Y H:i:s")."\r\nupdate: ".json_encode($update)."\r\n",FILE_APPEND);
          ...
          switch(true){
              ...
              case strlen(strip_tags($message)) < strlen($message) || !empty($photo) :
                ...
                if(!empty($photo)){
                    ...
                    $photo_parameters['parse_mode'] = "HTML";
  ...
  class Telegram extends TelegramController{
      ...
      //test
      //set webhook https://api.telegram.org/bot336199007:AAFBzJr4TIXJSn4ZvHwz13xQGAZD9ZkeLA8/setWebhook?url=https://test.bsn.ru/testtelegramBot/AAFBzJr4TIXJSn4ZvHwz13xQGAZD9ZkeLA8/
      protected static $bot_token = '336199007:AAFBzJr4TIXJSn4ZvHwz13xQGAZD9ZkeLA8';//токен бота для теста
      protected static $webhook_url = "https://test.bsn.ru/testtelegrambot/AAFBzJr4TIXJSn4ZvHwz13xQGAZD9ZkeLA8/";
      protected static $api_url = 'https://api.telegram.org/bot336199007:AAFBzJr4TIXJSn4ZvHwz13xQGAZD9ZkeLA8/';
      
      //production
      //set webhook https://api.telegram.org/bot311655806:AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/setWebhook?url=https://www.bsn.ru/testtelegramBot/AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/
      //protected static $bot_token = '311655806:AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk';//токен бота на продакшне
      //protected static $webhook_url = "https://www.bsn.ru/testtelegramBot/AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/";
      //protected static $api_url = 'https://api.telegram.org/bot311655806:AAE77AZcoimaQk7IwlVPQMnpbJtSnXn-vtk/';
      
      //режимы работы
      private static $input_modes = array("search", "search_deal_type", "search_typeobject", "search_param", "search_result");
      //команды
      ...
      private static $keywords = array('cost' => array('от','до','>','<','=','-'),
                                       'rooms' => array('комната','студия','однушка','двушка','трешка','многокомнатная'));
      
      //параметры поиска
      private static $search_array =  array('Цена' => array('title' => 'Задайте цену', 
                                                            'key' => 'cost', 
                                                            'comment' => "Укажите цену, например: '15000', 'от 15000' или 'до 15000', или же '15000-16000' и нажмите 'ввод'.\r\n"),
      ...
      private static $keyboards = array(//клавиатура по умолчанию
                                        ...
                                        'search_param' => array('keyboard' => array(array('Очистить','Закончить ввод')),
                                                                ...
                                                                'resize_keyboard' => true),
                                        //клавиатура поиска
                                        'search' => array('keyboard' => array(array('Цена', 'Район', 'Метро'),
                                                                              array('Отмена','Искать')),
                                                          'one_time_keyboard' => true,
                                                          'resize_keyboard' => true),
                                        ...
                                        'search_deal_type' => array('keyboard' => array(array("Снять посуточно"),
                                                                    ...
                                                                    'one_time_keyboard' => true,
                                                                    'resize_keyboard' => true),
                                        //клавиатура ввода типа объекта
                                        'search_typeobject' => array('keyboard' => array(array("студия"),
                                                                                        array("однушка"),
                                                                                        array("двушка"),
                                                                                        array('трешка'),
                                                                                        array('многокомнатная')),
                                                                    'one_time_keyboard' => true,
                                                                    'resize_keyboard' => true)
      );
      
      private static $result_block_length = 9;
      ...
      public static function processMessage($message_id,$chat_id,$input_text,$dialogline_id) {
          ...
          switch(true){
              ...
              case (empty($text)):
                ...
                $active_mode = self::getActiveMode($chat_id);
                self::sendMessage(array('chat_id' => $chat_id, 
                                                          "text" => "текст '".$input_text."' принят, нет действий для такого",
                                                          'reply_markup' => self::$keyboards[$active_mode]));
                break;
              ...
              case self::isInMode($chat_id,"search_deal_type"):
                    switch(true){
                       ...
                       case (in_array($text,call_user_func_array("array_merge",self::$keyboards['search_deal_type']['keyboard']))):
                         self::sendMessage(array('chat_id' => $chat_id,
                                                                  "text" => 'Хотим '.$text.". Что именно?",
                                                                  'reply_markup' => self::$keyboards['search_typeobject']));
                         self::endMode($chat_id,"search_deal_type");
                         self::startMode($chat_id,"search_typeobject");
                       break;
                   }
                   break;
              ///режим ввода типа объекта
              case self::isInMode($chat_id,"search_typeobject"):
                    switch(true){
                       case (in_array($text,self::$commands['search_end'])):
                         self::endMode($chat_id,"search_typeobject");
                         self::endMode($chat_id,"search");
                         self::sendMessage(array('chat_id' => $chat_id,
                                                 "text" => "Поиск остановлен",
                                                 'reply_markup' => self::$keyboards['default']));
                       break;
                       //корректное значение, идем дальше
                       case (in_array($text,call_user_func_array("array_merge",self::$keyboards['search_typeobject']['keyboard']))):
                         $params_description = self::formulateSearchParams($chat_id);
                         self::sendMessage(array('chat_id' => $chat_id,
                                                                  "text" => 'Хотим '.$params_description,
              ...
              case self::isInMode($chat_id,"search"):
                    switch(true){
                        ...
                        case (!empty(self::$search_array[$text]['title'])):
                            ...
                            $out_text = "Для завершения ввода нажмите закончить.";
                            if(!empty(self::$search_array[$text]['comment'])){
                                $out_text = self::$search_array[$text]['comment'].(strstr(self::$search_array[$text]['comment'],'ввод') !== false ? "" : $out_text);
                            }
                            
                            self::sendMessage(array('chat_id' => $chat_id, 
                                                                      "text" => $out_text.(!empty($param_values) ? "\r\nПринимаемые значения:\r\n".$param_values : ""),
                                                                      'reply_markup' => array(
                        ...
                        case in_array($text,self::$commands['search_start']):
                            ...
                            file_put_contents("modules/testtelegrambot/errors.log",date("d.m.Y H:i:s")." search params grabbed: ".json_encode($search_params)."\r\n\r\n",FILE_APPEND);
                            self::sendMessage(array('chat_id' => $chat_id,
      ...
      */
      public static function getSearchParams($chat_id){
          ...
          while(!empty($search_input)){
              ...
              //тип объекта теперь тоже задается отдельно
              if(in_array($item['message'],call_user_func_array("array_merge",self::$keyboards['search_typeobject']['keyboard']))){
                  $search_params['id_type_object'] = ($item['message'] == "комната" ? 2 : 1);
                  if($item['message'] == "комната"){
                      $search_params['id_type_object'] = 2;
                      $search_params['rooms_sale'] = 1;
                  }else{
                      $search_params['id_type_object'] = 1;
                      switch($item['message']){
                          case "однушка":
                            $search_params['rooms_sale'] = 1;
                            break;
                          case "двушка":
                            $search_params['rooms_sale'] = 2;
                            break;
                          case "трешка":
                            $search_params['rooms_sale'] = 3;
                            break;
                      }
                  }
                  continue;
      ...
      */
      private static function processSearchParams($search_params){
          ...
          $params = array_fill_keys(array_keys($search_params),array('value'=>0));
          ...
          if(!empty($search_params['cost'])){
              foreach($search_params['cost'] as $key=>$value){
                  $cost_value = trim(preg_replace('/[^0-9]/sui','',$value));
                  switch(true){
                      case preg_match('/[0-9]+\s*\-\s*[0-9]+/sui',$value):
                        $cost_values = explode('-',$value);
                        $params['cost']['to'] = array_pop($cost_values);
                        $params['cost']['from'] = array_pop($cost_values);
                        unset($params['cost']['value']);
                        break;
          ...
          $params['id_type_object']['value'] = $search_params['id_type_object'];
          $params['rooms_sale']['value'] = $search_params['rooms_sale'];
          ...
          if(!empty($search_params['search_param_rooms'])){
              ...
              switch(true){
                  case in_array($rooms,array("однушка","двушка","трешка","многокомнатная")):
      ...
      * @param mixed $chat_id
      */
      public static function searchWithParams($chat_id,$from = false){
          ...
          file_put_contents("modules/testtelegrambot/errors.log","SEARCH: from=".$from ."*". self::$result_block_length." params=".json_encode($search_params)."\r\n",FILE_APPEND);
