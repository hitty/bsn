...
class PHPechkin {
    ...
    //get data by method
    public function getData($method = null, $params = []) {
        if (!is_string($method))
    ...
    */
    public function lists_add($name = null, $params = []) {
        if (!is_null($name))
    ...
    */
    public function lists_update($list_id = null, $params = []) {
        if (!is_null($list_id))
    ...
    */
    public function lists_get_members($list_id = null, $params = []) {
        if (!is_null($list_id))
    ...
    */
    public function lists_upload($list_id = null, $file = null, $email = null, $params = []) {
    ...
    */
    public function lists_add_member($list_id = null, $email = null, $params = []) {
    ...
    */
    public function lists_update_member($member_id = null, $params = []) {
    ...
    */
    public function lists_unsubscribe_member($params = []) {
    ...
    */
    public function lists_add_merge($list_id = null, $type = null, $params = []) {
    ...
    */
    public function lists_update_merge($list_id = null, $merge_id = null, $params = []) {
    ...
    */
    public function campaigns_create($list_id = null, $params = []) {
        if (!is_array($list_id))
            return $this->getError('3');
    ...
    */
    public function campaigns_create_auto($params = []) {
    ...
    */
    public function campaigns_update($campaign_id = null, $params = []) {
    ...
    */
    public function campaigns_update_auto($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params['list_id'] = serialize($params['list_id']);
    ...
    */
    public function campaigns_attach($campaign_id = null, $url = null, $params = []) {
    ...
    */
    public function campaigns_get_attachments($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
    ...
    */
    public function campaigns_delete_attachments($campaign_id = null, $id = null, $params = []) {
    ...
    */
    public function campaigns_get_templates($params = []) {
    ...
    */
    public function campaigns_force_auto($campaign_id = null, $email = null, $params = []) {
    ...
    */
    public function reports_sent($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
    ...
    */
    public function reports_delivered($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
    ...
    */
    public function reports_opened($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
    ...
    */
    public function reports_unsubscribed($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
    ...
    */
    public function reports_bounced($campaign_id = null, $params = []) {
        if (is_null($campaign_id))
            return $this->getError('3');
        $required = array('campaign_id' => $campaign_id);
        $params = array_merge($required, $params);
