...
function CheckAuthentication()
{
    ...
    //file_put_contents("C:/aaa.txt",print_r($GLOBALS,true));    
	// ... where $_SESSION['IsAuthorized'] is set to "true" as soon as the
	// user logs in your system. To be able to use session variables don't
	// forget to add session_start() at the top of this file.
    //return !empty($_SESSION['auth_data']['user_password']);
	return true;
}
...
$config['LicenseKey'] = '2P11EFGH1JK11NOPQRSTUVWXY41';
...
*/
$baseUrl = 'https://www.bsn.ru/img/uploads/';
...
$config['ResourceType'][] = Array(
		...
		'deniedExtensions' => 'exe,bat,com,js,php,html,htm,phtml,shtml,asp,c,py,aspx');
...
$config['plugin_imageresize']['smallThumb'] = '90x67';
$config['plugin_imageresize']['mediumThumb'] = '120x90';
$config['plugin_imageresize']['largeThumb'] = '180x135';
