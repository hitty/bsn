#!/usr/bin/php
<?php
define('DEBUG_MODE', (!empty($_SERVER['SERVER_NAME']) && preg_match('/.+\.int$/i', $_SERVER['SERVER_NAME']))  || (!empty($_SERVER['SCRIPT_NAME']) && preg_match('/.+\.int/i', $_SERVER['SCRIPT_NAME'])) ? true : false);
