...
for( $i=1; $i<=10; $i++ ){
    ...
    ");
    $db->query( " DELETE FROM " . $sys_tables['banners_stats_show_day'] ." WHERE DATE(`datetime`) = CURDATE() - INTERVAL " . $i  . " DAY ");
    $db->query( " DELETE FROM " . $sys_tables['banners_stats_click_day'] ." WHERE DATE(`datetime`) = CURDATE() - INTERVAL " . $i  . " DAY ");
}
?>