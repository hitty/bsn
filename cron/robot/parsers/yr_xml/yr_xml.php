...
if(!empty($log['download'])){
    ...
    if(!empty($agency_xml_info['id']) && !empty($xml_size)) $db->query("UPDATE ".$sys_tables['agencies']." SET xml_file_processing = 0, xml_last_size = ".$xml_size." WHERE id = ".$agency_xml_info['id']);
}
?>
