...
//to set webhook: https://api.telegram.org/bot312438821:AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/setWebhook?url=https://test.bsn.ru/telegramBot/AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/
//channel invite https://telegram.me/joinchat/DzEfMkGPSqZgaT5TTH8JNQ
//our channel ID: -1001099909798
//bot to channel: https://api.telegram.org/bot312438821:AAE8H5LMHVho5nthOCxkGgCfgsFiuBV1R7A/sendMessage?chat_id=@joinchannel_BSNRU&text=123
...
//Telegram::apiRequest("setWebhook",array("url" => "https://test.bsn.ru/telegramBot/"));
...
$result = TelegramController::acceptRequest();

if(empty($result)){
    file_put_contents("modules/telegramBot/errors.log","404!!!".$_SERVER['REQUEST_METHOD']."; ".$_SERVER['REQUEST_URI']."\r\n",FILE_APPEND);
...
//$update = json_decode('{"update_id":86617271,"message":{"message_id":3132,"from":{"id":254877490,"first_name":"\u041c\u0438\u0448\u0430"},"chat":{"id":254877490,"first_name":"\u041c\u0438\u0448\u0430","type":"private"},"date":1484047388,"text":"2"}}',true);
//TelegramController::acceptMessage($update['message']);
