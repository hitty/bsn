...
$GLOBALS['css_set'][] = '/modules/doverie/common.css';
$GLOBALS['css_set'][] = '/modules/doverie/styles.css';

$GLOBALS['js_set'][] = '/js/jquery.min.js';
$GLOBALS['js_set'][] = '/modules/doverie/jquery.popup.window.js';
$GLOBALS['js_set'][] = '/modules/doverie/script.js';
