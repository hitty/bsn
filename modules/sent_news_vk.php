...
include('includes/robot_functions.php');    // функции  из крона
...
echo 'get:'.print_r($get_parameters) . '; post:'.print_r($post_parameters);
if(!empty($get_parameters['get_code'])){
    ...
    if(!empty($post_parameters)){
        ...
        echo "<form method=\"POST\" action=\"/modules/sent_news_vk.php?get_token=1\"><input type=\"text\" value=\"\" name=\"code\"/><input type=\"submit\" value=\"Отправить\" /></form>";
    }
}  else {
    ...
    $list = $news->getList(30,0,false,false,false,'vkontakte_feed = 1 AND published = 1');
